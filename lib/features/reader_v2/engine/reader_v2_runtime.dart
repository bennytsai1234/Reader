...
class ReaderV2Runtime extends ChangeNotifier {
  ...
  Future<TextPage> _pageForRestoreLocation(ReaderV2Location location) async {
  ...
  Future<TextPage> _slidePageForRestoreLocation(
    ReaderV2Location location,
  ) async {
  ...
  Future<ReaderV2PageWindow> _windowAroundPage(TextPage page) async {
