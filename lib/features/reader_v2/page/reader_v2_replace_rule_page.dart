...
import 'package:inkpage_reader/features/reader_v2/widgets/reader_v2_replace_rule_editor_sheet.dart';

class ReaderV2ReplaceRulePage extends StatefulWidget {
  const ReaderV2ReplaceRulePage({super.key});

  @override
  State<ReaderV2ReplaceRulePage> createState() => _ReaderV2ReplaceRulePageState();
}
                      ...
                      child: Row(
                        ...
                        children: [
                          Switch(
                            ...
                            onChanged:
                                (value) => _toggleEnabled(rule, value),
                          ),
                          IconButton(
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder:
          (context) => AlertDialog(
            ...
            content: Text('確定刪除「${rule.name.isEmpty ? rule.pattern : rule.name}」？'),
            actions: [
              TextButton(
